...
<div class="mb-6" data-aos="fade-up">
    <h1 class="text-2xl md:text-3xl font-bold text-gray-800 flex items-center">
        <i class="fas fa-comments text-green-600 mr-2"></i> Manage Topics
    </h1>
    <p class="text-gray-600 mt-2">Manage all discussion topics in the system</p>
</div>
...
<div class="bg-white rounded-lg shadow-md overflow-hidden" data-aos="fade-up" data-aos-delay="100">
    <div class="bg-gradient-to-r from-green-600 to-green-700 p-4">
        <div class="flex justify-between items-center">
            <h2 class="text-white font-bold">All Topics</h2>
        ...
        <table class="min-w-full">
            <thead>
                <tr class="bg-gray-50 border-b">
                    <th class="px-6 py-3 text-left text-sm font-medium text-gray-500">Topic</th>
                ...
                <tr class="hover:bg-gray-50 transition">
                    <td class="px-6 py-4">
                        ...
                        <p class="text-gray-500 text-sm mt-1 line-clamp-1">
                            {{ \Illuminate\Support\Str::limit($topic->content, 60) }}
                        </p>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        @else
                            <span class="text-gray-700">{{ $topic->author_name }}</span>
                        @endif
                    </td>
                ...
                <tr>
                    <td colspan="5" class="px-6 py-4 text-center text-gray-500">
                        <div class="flex flex-col items-center justify-center py-8">
                            <img src="{{ asset('images/empty.svg') }}" alt="No topics" class="w-40 mb-4">
                            <p>No topics found in the system</p>
                        </div>
                    </td>
                </tr>
                @endforelse
